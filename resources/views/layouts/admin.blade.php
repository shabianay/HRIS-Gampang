                        ...
                        <div class="pt-5 mt-4 border-t border-slate-100">
                            ...
                            <div class="mt-2 space-y-0.5">
                                ...
                                <a href="{{ route('logs.index') }}"
                                    ...
                                    <svg class="h-5 w-5 flex-shrink-0 {{ request()->routeIs('logs.*') ? 'text-primary-600' : 'text-slate-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                    Log Aktivitas
                                </a>
                            </div>
                        </div>
