        ...
        <div class="card p-6 sm:p-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                <div class="bg-slate-50 rounded-xl p-4">
                    ...
                    <p class="text-sm font-bold text-slate-900 mt-1">{{ $attendance->employee->full_name }}</p>
                </div>
                <div class="bg-slate-50 rounded-xl p-4">
                    <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider">NIK</p>
                    <p class="text-sm font-bold text-slate-900 mt-1">{{ $attendance->employee->nik }}</p>
                </div>
                <div class="bg-slate-50 rounded-xl p-4">
                    <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Departemen</p>
                    <p class="text-sm font-bold text-slate-900 mt-1">{{ $attendance->employee->department?->name ?? '-' }}</p>
                </div>
            </div>
