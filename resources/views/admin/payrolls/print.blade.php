    ...
    <div>
        ...
        <div id="payslip" class="card p-6 sm:p-10">
            <div class="text-center mb-8 pb-6 border-b-2 border-slate-300">
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight uppercase">Slip Gaji</h1>
            ...
            <div class="grid grid-cols-2 gap-6 mb-8">
                ...
                <div>
                    ...
                    <p class="text-sm font-medium text-slate-900 mt-0.5">{{ $payroll->payment_date ? $payroll->payment_date->format('d/m/Y') : '-' }}</p>
                </div>
                <div>
            ...
            <div class="text-center text-xs text-slate-400 mt-8 pt-4 border-t border-slate-200">
                ...
                <p class="mt-1">Dicetak pada: {{ now()->format('d/m/Y H:i') }}</p>
            </div>
        </div>
    </div>
</x-admin-layout>
