    ...
    <div id="payslip" class="card p-6 sm:p-10">
        ...
        <div class="mb-8 grid grid-cols-2 gap-6">
            ...
            <div>
                <p class="text-xs font-semibold uppercase tracking-wider text-slate-500">Tanggal Bayar</p>
                <p class="mt-0.5 text-sm font-medium text-slate-900">{{ $payroll->payment_date ? $payroll->payment_date->format('d/m/Y') : '-' }}</p>
            </div>
            <div>
